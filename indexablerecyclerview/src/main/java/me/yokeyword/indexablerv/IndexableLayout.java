...
public class IndexableLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mBarTextColor = a.getColor(R.styleable.IndexableRecyclerView_rv_indexBar_textColor, ContextCompat.getColor(context, R.color.default_indexBar_textColor));
            mBarTextSize = a.getDimension(R.styleable.IndexableRecyclerView_rv_indexBar_textSize, getResources().getDimension(R.dimen.default_indexBar_textSize));
            ...
            mBarTextSpace = a.getDimension(R.styleable.IndexableRecyclerView_rv_indexBar_textSpace, getResources().getDimension(R.dimen.default_indexBar_textSpace));
            mBarBg = a.getDrawable(R.styleable.IndexableRecyclerView_rv_indexBar_background);
            mBarWidth = a.getDimension(R.styleable.IndexableRecyclerView_rv_indexBar_layout_width, getResources().getDimension(R.dimen.default_indexBar_layout_width));
            a.recycle();
        }
    ...
    private void initCenterOverlay() {
        ...
        mCenterOverlay.setTextColor(mBarFocusTextColor);
