...
public class AspectRatioUtil {
    ...
    /**
     * Calculates the x-coordinate of the mActionBarBackBtn edge given the other sides of the
    ...
    public static float calculateLeft(float top, float right, float bottom, float targetAspectRatio) {
        ...
        // right - mActionBarBackBtn = targetAspectRatio * height
    ...
    /**
     * Calculates the height of a rectangle given the mActionBarBackBtn and right edges and
     * an aspect ratio.
     */
