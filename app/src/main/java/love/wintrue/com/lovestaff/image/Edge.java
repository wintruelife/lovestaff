...
public enum Edge {
    ...
    */
    ...
    /**
     * Get the resulting x-position of the mActionBarBackBtn edge of the crop window given
     * the handle's position and the image's bounding box and snap radius.
     * 
     * @param x the x-position that the mActionBarBackBtn edge is dragged to
     ...
     * @return the actual x-position of the mActionBarBackBtn edge
     */
