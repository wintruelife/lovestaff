 ...
 * @date: 2017/5/11 0011 上午 11:21
 */
public class WebLongClickedPopWindow extends PopupWindow {
     ...
     */
    public WebLongClickedPopWindow(Context context, int type, int width, int height) {
        super(context);
...
//               break;
            case IMAGE_VIEW_POPUPWINDOW: //图片
                this.itemLongClickedPopWindowView = this.itemLongClickedPopWindowInflater.inflate(R.layout.widget_webview_longclicked_img, null);
                break;
        }
    }
