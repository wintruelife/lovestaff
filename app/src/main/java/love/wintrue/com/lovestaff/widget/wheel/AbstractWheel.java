...
import love.wintrue.com.lovestaff.widget.wheel.adapter.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
        ...
        if (changed) {
            ...
            if (mLayoutWidth != w || mLayoutHeight != h) {
                ...
                if(mWidth > 0 && mHeight > 0){
                    LogUtil.e("onLayout()", "recreateAssets");
    ...
    public void setCurrentItem(int index, boolean animated) {
        ...
        if (index != mCurrentItemIdx) {
            ...
            notifyChangingListeners(mCurrentItemIdx, mCurrentItemIdx);
        }
    }
    ...
    protected void notifyScrollingListenersAboutEnd() {
        for (OnWheelScrollListener listener : scrollingListeners) {
            listener.onScrollingFinished(this,mCurrentItemIdx);
        }
    }
    ...
    public void setSelectedIndex(int index) {
        mViewAdapter.setSelectedIndex(index);
    }
