...
public class FrescoImageMemoryCacheSupplier implements Supplier<MemoryCacheParams> {

    private final ActivityManager mActivityManager;

    public FrescoImageMemoryCacheSupplier(ActivityManager activityManager) {
    ...
    private int getMaxCacheSize() {
        ...
        LogUtil.i(String.format("Fresco Max memory [%d] MB", (maxMemory/ByteConstants.MB)));
