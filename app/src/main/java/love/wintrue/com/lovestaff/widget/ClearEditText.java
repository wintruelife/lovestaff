...
public class ClearEditText extends AppCompatEditText implements OnFocusChangeListener, TextWatcher {
	...
	/**
	 * 是否开启OnFocusChangeListener
	 */
	private boolean mEnableFocusChange = true;
	...
	private void init() {
		...
		if (mClearDrawable == null) {
			...
			mClearDrawable = getResources().getDrawable(R.drawable.clear_tv_delete_selector);
		}
	...
	public void onFocusChange(View v, boolean hasFocus) {
		...
		LogUtil.e("mEnableFocusChange",mHasFoucs+"");
	}
	...
	public void setEnableFocusChange(boolean enableFocusChange) {
		mEnableFocusChange = enableFocusChange;
	}
