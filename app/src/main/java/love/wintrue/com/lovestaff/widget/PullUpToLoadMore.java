...
public class PullUpToLoadMore extends ViewGroup {
    ...
    public void setListener(ViewChange listener) {
        this.listener = listener;
    }

    private ViewChange listener;
    ...
    private void smoothScroll(int tartY) {
        if(listener != null){
            if(tartY == 0) {
                listener.ChangeView(false);
            }else {
                listener.ChangeView(true);
            }
        }
    ...
    public void scrollToPage1() {
        smoothScroll(position1Y);
        currPosition=1;
        topScrollView.smoothScrollTo(0,position1Y);
    }
    ...
    public interface ViewChange{
        public void ChangeView(Boolean isTop);
        public void buttomChangeView(Boolean isTop);
    }
