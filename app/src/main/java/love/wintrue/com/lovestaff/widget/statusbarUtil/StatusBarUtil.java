...
public class StatusBarUtil {
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout, int color, int statusBarAlpha) {
        ...
        // 设置属性
        ViewGroup drawerLeft = (ViewGroup) drawerLayout.getChildAt(1);
        ViewGroup drawerRight = (ViewGroup) drawerLayout.getChildAt(2);

        drawerLayout.setFitsSystemWindows(false);
        contentLayout.setFitsSystemWindows(false);
        contentLayout.setClipToPadding(true);
        drawerLeft.setFitsSystemWindows(false);
        drawerRight.setFitsSystemWindows(false);
        addTranslucentView(activity, statusBarAlpha);
    }
