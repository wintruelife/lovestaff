...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ImageCropImageView, 0, 0);

        try {
            mGuidelines = ta.getInteger(R.styleable.ImageCropImageView_guidelines, DEFAULT_GUIDELINES);
            mFixAspectRatio = ta.getBoolean(R.styleable.ImageCropImageView_fixAspectRatio, DEFAULT_FIXED_ASPECT_RATIO);
            mAspectRatioX = ta.getInteger(R.styleable.ImageCropImageView_aspectRatioX, DEFAULT_ASPECT_RATIO_X);
            mAspectRatioY = ta.getInteger(R.styleable.ImageCropImageView_aspectRatioY, DEFAULT_ASPECT_RATIO_Y);
            mImageResource = ta.getResourceId(R.styleable.ImageCropImageView_imageResource, DEFAULT_IMAGE_RESOURCE);
        } finally {
            ta.recycle();
        }
    ...
    public Bitmap getCroppedImage() {
        ...
        LogUtil.e("actualCropX:"+actualCropX);
        LogUtil.e("actualCropY:"+actualCropY);
        LogUtil.e("actualCropWidth:"+actualCropWidth);
        LogUtil.e("actualCropHeight:"+actualCropHeight);
        // Crop the subset from the original Bitmap.
        if(actualCropX >= 0 && actualCropY >= 0 && actualCropWidth >= 0 && actualCropHeight >= 0) {
    ...
    private void init(Context context) {
        ...
        final View v = inflater.inflate(R.layout.widget_image_crop, this, true);
