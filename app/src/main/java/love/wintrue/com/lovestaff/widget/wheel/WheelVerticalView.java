...
public class WheelVerticalView extends AbstractWheelView {
    ...
    /**
     * The height of the selection widget_gird_password_divider.
     */
    ...
    public void setSelectorPaintCoeff(float coeff) {
        ...
        if (mVisibleItems == 2) {
            ...
            int[] colors =      {0xff333333, 0xff333333, 0xffff6600, 0xffff6600, 0xff333333, 0xff333333};
            ...
            int[] colors =      {0xff333333, 0xff333333, 0xff333333, 0xff333333, 0xffff6600, 0xffff6600, 0xff333333, 0xff333333, 0xff333333, 0xff333333};
    ...
    protected void drawItems(Canvas canvas) {
        ...
        if (mSelectionDivider != null) {
            // draw the top widget_gird_password_divider
            int topOfTopDivider = (getHeight() - ih - mSelectionDividerHeight) / 2;
            int bottomOfTopDivider = topOfTopDivider + mSelectionDividerHeight;
            mSelectionDivider.setBounds(DensityUtil.dip2px(mContext,10), topOfTopDivider-DensityUtil.dip2px(mContext,3), w-DensityUtil.dip2px(mContext,10), bottomOfTopDivider-DensityUtil.dip2px(mContext,3));
            mSelectionDivider.draw(cSeparators);

            // draw the bottom widget_gird_password_divider
            int topOfBottomDivider =  topOfTopDivider + ih;
            int bottomOfBottomDivider = bottomOfTopDivider + ih;
            mSelectionDivider.setBounds(DensityUtil.dip2px(mContext,10), topOfBottomDivider+DensityUtil.dip2px(mContext,3), w-DensityUtil.dip2px(mContext,10), bottomOfBottomDivider+DensityUtil.dip2px(mContext,3));
            mSelectionDivider.draw(cSeparators);
        }
