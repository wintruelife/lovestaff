...
public class FileUtils {
    ...
    public static Uri createPath(Context context, String customPath, String fileName) {
        final File f = new File(customPath);
        if (!f.exists()) {
            f.mkdirs();
        }
        File out = new File(customPath, fileName);
    ...
    public static String getSDPath(Context context) {
        ...
        if (sdCardExist) {
            sdDir = Environment.getExternalStorageDirectory();// 获取跟目录getExternalStorageDirectory
        } else {
